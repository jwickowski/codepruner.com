...
Now you can generate the code, if you want to know how to use it in your project. Go to next post and check [how to use apiClient generated by swagger-typescript-api]({{< relref "./how-to-use-apiClient-generated-by-swagger-typescript-api.md">}})
