...
disqus_url: 'https://codepruner.com/how-to-migrate-from-javascript-to-typescript-without-wasting-time'
draft: false
images:
  - images/posts/2021/2021-07-18-how-to-migrate-from-javascript-to-typescript-without-wasting-time.png
tags:
  - javascript
  - typescript
  - legacy
...
5. If you have to touch a `.js` file, to modify or to import from `.ts` file. Then
   ...
   * Everywhere where are no types use `any`
     * or I recommend to use `fakeAny`. You can read more about that in post [How to handle `noImplicitAny` during migration fom js to ts]({{< relref "../2021/2021-07-18-how-to-handle-notImplictAny-during-migration-from-js-to-ts.md">}})
